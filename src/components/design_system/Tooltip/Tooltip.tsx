                ...
                createPortal(
                    <div
                        ...
                        className={classNames(
                            "fixed whitespace-nowrap rounded-full",
                            "bg-zinc-700 px-3 py-1.5 text-sm font-medium text-white shadow-lg",
                    ...
                    >
                        {content}
                        <span
                            className={`absolute h-2 w-2 rotate-45 bg-zinc-700 ${arrowMap[position]}`}
                        />
                    </div>,
                    document.body,
                )}
...
TooltipProps.displayName = "BaseTooltip";
